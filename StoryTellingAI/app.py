...
# Route to serve the "book.png" image
@app.get("/book.png")
async def get_image():
            ...
            try:
                            ...
                            if token.startswith(" "):
                                if word:
                                    try:
                                        ...
                                        print(f"Error sending word to WebSocket: {e}")
                                        is_open = False
                                        break
                                    sentence += word
                                word = token
                ...
                if word and is_open:
                    try:
                        ...
                        print(f"Error sending final word to WebSocket: {e}")
                        is_open = False
                    sentence += word
                if sentence and is_open:
                    ...
                    if image_data:
                        ...
                        try:
                            ...
                            print(f"Error sending final image to WebSocket: {e}")
                    # await speak(sentence, selected_device_index)
